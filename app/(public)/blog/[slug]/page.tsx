    ...
    const mockBlogs = [
      {
        ...
        excerpt: "Barakah Agency was founded on the belief that growth is not neutral...",
        content: `
        ...
        published: true,
        cover_image: "https://images.unsplash.com/photo-1557804506-669a67965ba0?auto=format&fit=crop&q=80&w=1200",
      },
      {
        id: "2",
        title: "Practical Strategy for the Long Term",
        description: "Moving beyond surface-level metrics to build foundations that last.",
        excerpt: "Moving beyond surface-level metrics to build foundations that last.",
      ...
      },
      {
        ...
        description: "How to maintain your principles while growing your reach.",
        excerpt: "How to maintain your principles while growing your reach.",
        content: "<p>Scaling with integrity is the core challenge for modern organizations. Discover how to build systems that scale your impact without compromising your ethics.</p>",
        category: "Frameworks",
        slug: "ethical-scaling",
        created_at: new Date().toISOString(),
        published: true,
        cover_image: "https://images.unsplash.com/photo-1454165833767-bb2d6f44888e?auto=format&fit=crop&q=80&w=1200",
      }
    ]
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20">
          ...
          <div className="lg:col-span-8 space-y-8">
            <header className="space-y-6">
              <h1 className="text-4xl md:text-5xl lg:text-7xl font-black text-[#381e11] leading-[1.1] tracking-tight">
                {blog.title}
              </h1>
            ...
            <div
              className="prose prose-lg max-w-none prose-headings:text-[#381e11] prose-headings:font-black prose-p:text-[#5c4033] prose-p:leading-relaxed prose-img:rounded-3xl prose-img:shadow-xl prose-strong:text-[#381e11] prose-blockquote:border-[#E76F3D] prose-blockquote:bg-[#FFF5F2]/50 prose-blockquote:rounded-2xl prose-blockquote:p-6"
