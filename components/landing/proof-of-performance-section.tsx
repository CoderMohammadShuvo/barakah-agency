...
const caseStudies = [
    {
        ...
        description: "We begin by deeply understanding your mission, values, and the impact you want to create. Every strategy is aligned with your ethical foundations, cultural context, and long-term vision, ensuring your marketing reflects what your brand truly stands for, not just what it sells.",
        metrics: [
    ...
    },
    {
        id: 3,
        title: "Halal Expo",
        logo: "HALAL EXPO & SUMMIT",
        logoSubtext: "6TH US International",
        logoColor: "#5a7ba8",
        tags: ["Event Marketing Strategy", "Paid Media"],
        description: "We begin by deeply understanding your mission, values, and the impact you want to create. Every strategy is aligned with your ethical foundations, cultural context, and long-term vision.",
        metrics: [],
        bgColor: "from-orange-200 to-orange-300"
    },
    {
        ...
        logo: "TEN PEAKS SHUTTLE & TOURS",
        logoColor: "#2563eb",
        tags: ["Tourism Marketing Strategy", "Paid Media"],
        description: "We begin by deeply understanding your mission, values, and the impact you want to create. Every strategy is aligned with your ethical foundations.",
        metrics: [],
        bgColor: "from-orange-200 to-orange-300"
    }
]
        ...
        <section className="relative py-20 md:py-32 bg-background overflow-hidden">
            <div className="container mx-auto px-4 lg:px-8">
                ...
                <div className="text-center mb-4">
                    <p className="text-sm font-semibold text-[#381e11] mb-2 font-lato">• Results •</p>
                    ...
                    {caseStudies.map((study) => (
                        ...
                        >
                            <div className="grid grid-cols-1 lg:grid-cols-2 h-full min-h-[300px]">
                                ...
                                {/* Right Column - Logo */}
                                <div className={`relative overflow-hidden bg-gradient-to-br ${study.bgColor} p-12 flex items-center justify-center min-h-[300px]`}>
                                    <motion.div
                                        variants={{
                                    ...
                                    >
                                        {study.logoSubtext && (
                                            <p className="text-[10px] uppercase tracking-[0.2em] text-[#381e11]/60 mb-3 font-lato font-bold">
                                                {study.logoSubtext}
                                            </p>
                                        )}
                                        <div
                                            className="text-4xl md:text-5xl font-black font-lato tracking-tighter"
                                            style={{ color: study.logoColor }}
                                        >
                                            {study.logo}
                                        </div>
                                    </motion.div>
