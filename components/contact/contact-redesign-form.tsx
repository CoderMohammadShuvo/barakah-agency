    ...
    if (isSuccess) {
        return (
            <div className="py-20 text-center">
                ...
                <h2 className="text-3xl font-black text-[#381E11] mb-4">Request Sent Successfully!</h2>
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-12 pb-24">
            ...
            <div className="space-y-6">
                <h3 className="text-2xl font-black text-[#381E11] font-lato">i'm interested in..</h3>
                <div className="flex flex-wrap gap-3">
                        ...
                        <button
                            ...
                            className={cn(
                                ...
                                selectedServices.includes(service)
                                    ? "bg-[#381E11] border-[#381E11] text-white"
                                    : "border-gray-200 text-gray-700 hover:border-[#381E11]"
                            )}
                        >
                            {service}
                        </button>
                    ...
                    <button
                        type="button"
                        className="px-6 py-3 rounded-full border-2 border-gray-200 text-gray-700 font-lato font-bold text-sm lg:text-base hover:border-[#381E11]"
                    >
                        Other
                    </button>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-10">
                <div className="space-y-2 border-b-2 border-gray-100 focus-within:border-[#381E11] transition-colors">
                    <input
                        {...register("name")}
                ...
                <div className="border-b-2 border-gray-100 focus-within:border-[#381E11] transition-colors md:col-span-2">
                    <input
                        {...register("company")}
            ...
            {/* Budget Section */}
            <div className="space-y-6">
                <h3 className="text-2xl font-black text-[#381E11] font-lato">Monthly Budget</h3>
                <div className="flex flex-wrap gap-3">
                    {budgets.map((budget) => (
                        <button
                            key={budget}
            ...
            <div className="pt-4">
                ...
                >
                    <span className="text-xl font-black">{isSubmitting ? "Sending Request..." : "Send Request"}</span>
                    <div className="h-10 w-10 flex items-center justify-center bg-white rounded-full group-hover:translate-x-1 transition-transform">
                        {isSubmitting ? <Loader2 className="h-5 w-5 text-[#E76F3D] animate-spin" /> : <ArrowRight className="h-6 w-6 text-[#E76F3D]" />}
                    </div>
                </button>
            </div>
        </form>
