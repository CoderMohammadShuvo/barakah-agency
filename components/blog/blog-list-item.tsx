...
export function BlogListItem({ blog }: BlogListItemProps) {
    return (
        ...
        >
            <div className="flex flex-col-reverse md:flex-row gap-8 md:gap-12 items-center md:items-start text-[#381e11]">
                ...
                <div className="flex-1 space-y-6">
                    ...
                    <div className="flex flex-wrap items-center gap-4 text-sm font-bold">
                        ...
                        <span className="text-[#5c4033]/60">{formatDate(blog.created_at)}</span>
                    </div>
                </div>
