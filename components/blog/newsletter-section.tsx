        ...
        <div className="flex flex-col lg:flex-row items-center justify-between p-8 md:p-12 lg:p-16 gap-12">
          ...
          <div className="flex-1 flex flex-col md:flex-row items-center gap-8 md:gap-12 text-center md:text-left">
            ...
            <div className="space-y-4">
              <h2 className="text-4xl md:text-5xl font-black text-[#3F1200] tracking-tight">
                Join Our Newsletter
              </h2>
              <p className="text-[#5c4033] text-lg font-medium leading-relaxed max-w-md">
                Receive fresh articles straight in your inbox, every Friday
                morning. We also share interesting finds from the internet!
              </p>
              ...
              <form className="relative flex flex-col sm:flex-row gap-3 md:gap-4 pt-4">
                <div className="flex-1 relative">
                  <Input
                    ...
                    className="h-14 px-6 rounded-full border-[#F0EBE8] bg-white text-[#3F1200] placeholder:text-[#5c4033]/40 focus:ring-[#E76F3D]/20 focus:border-[#E76F3D] text-lg shadow-sm"
                  />
                </div>
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="relative w-full h-full">
                ...
                >
                  ...
                  >
                    <path
                      d="M20 60 L100 120 L180 60 L180 160 C 180 165, 175 170, 170 170 L30 170 C 25 170, 20 165, 20 160 Z"
                      fill="#FFFFFF"
                    />
                    <path
                      d="M20 60 L100 120 L180 60 L100 30 Z"
                      fill="#E76F3D"
                    />
                    <path
                      d="M100 120 L20 60 L30 170 L100 120 Z"
                      fill="#F5F5F7"
                      opacity="0.6"
                    />
                    <path
                      d="M100 120 L180 60 L170 170 L100 120 Z"
                      fill="#F5F5F7"
                      opacity="0.6"
                    />
                  </svg>
