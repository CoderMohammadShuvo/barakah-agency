    ...
    return (
        <aside className="space-y-12">
            ...
            <div className="space-y-8">
                <h3 className="text-2xl font-black text-[#381e11]">Related Blogs</h3>
                    ...
                    {relatedBlogs.map((blog) => (
                        ...
                        >
                            ...
                            <div className="space-y-2">
                                ...
                                <h4 className="text-lg font-black text-[#381e11] leading-tight transition-colors group-hover:text-[#E76F3D]">
                                    {blog.title}
                                </h4>
                            </div>
                        </Link>
