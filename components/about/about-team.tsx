...
const teamMembers = [
    {
        ...
        description: "Focuses on growth strategy ethical frameworks and long term direction across all client engagements.",
        ...
        <section className="py-24 bg-white">
            <div className="container mx-auto px-4">
                ...
                <div className="text-center mb-20 max-w-4xl mx-auto">
                    ...
                    >
                        The People Behind the Work<br />& the Agents of Barakah
                    </motion.h2>
                    <motion.p
                        initial={{ opacity: 0, y: 20 }}
                        whileInView={{ opacity: 1, y: 0 }}
                    ...
                    >
                        Meet the people who make Barakah possible — not just by doing great work, but by showing up with sincerity, creativity, and a shared commitment to purpose-driven growth. Each team member brings a unique skillset and a deep alignment with the ethics we live by.
                    </motion.p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {teamMembers.map((member, idx) => (
                        ...
                        >
                            ...
                            <div
                                className="absolute inset-0 bg-gradient-to-br from-[#E76F3D] to-[#FBD3C1]"
                            />
                            ...
                            <div className="absolute inset-0 z-10 p-2">
                                <div className="relative h-full w-full rounded-[1.8rem] overflow-hidden">
                                    ...
                                    <div className="absolute inset-0 p-8 flex flex-col justify-end">
                                        ...
                                        <motion.span
                                            className="text-lg font-medium text-white/90 mb-3 block"
                                        >
                                            {member.role}
                                        </motion.span>
                                        <motion.p
