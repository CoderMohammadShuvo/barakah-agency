...
export function AboutHero() {
    return (
        <section className="relative min-h-[80vh] flex items-center justify-center overflow-hidden bg-[#FFF5F0] pt-20">
            ...
            <div className="container relative z-10 mx-auto px-4 text-center">
                ...
                >
                    ...
                    <motion.h1
                        ...
                        className="text-5xl md:text-7xl lg:text-8xl font-black text-[#381E11] leading-[1.1] tracking-tighter font-lato"
                    >
                    ...
                    >
                        Barakah Agency partners with top brands worldwide to preserve their values,
                        strengthen their reputation, and design ethical marketing strategies
