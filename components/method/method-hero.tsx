            ...
            <div className="container relative z-10 mx-auto px-4">
                <div className="max-w-4xl">
                    ...
                    <motion.h1
                        ...
                        className="text-6xl md:text-8xl lg:text-9xl font-black text-[#381E11] leading-none mb-8 tracking-tighter font-lato"
                    >
                        The Barakah<br />Method
                    </motion.h1>
                    ...
                    <motion.p
                        ...
                        className="text-xl md:text-2xl text-[#5C4033] leading-relaxed mb-10 max-w-2xl"
                    >
                        The Barakah Method is our proprietary framework that sustains your values-aligned brand growth.
                        It blends cultural insight, ethical design, and data-led marketing to grow the legacy customers you deserve.
                    </motion.p>
