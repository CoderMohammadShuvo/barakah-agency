...
export function BarakahExperienceHero() {
    return (
        <section className="relative min-h-[80vh] flex flex-col items-center justify-center overflow-hidden bg-[#FFF5F0] pt-32 pb-20">
            ...
            <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                ...
                <svg
                    ...
                    className="absolute w-[120%] h-[120%] text-[#E76F3D]/10 opacity-70"
                    fill="none"
            ...
            <div className="container relative z-10 mx-auto px-4 text-center">
                ...
                >
                    ...
                    >
                        Where Specialized Expertise<br />
                    ...
                    >
                        The Barakah Ecosystem brings together industry-specific brands under one guiding ethos.
                        This ecosystem model allows us to deliver focused solutions without compromising on
                        ethics, quality, or long-term impact.
                    </motion.p>
