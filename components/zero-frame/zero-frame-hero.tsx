        ...
        <section className="relative min-h-screen flex flex-col items-center justify-start overflow-hidden bg-[#FFF5F0] pt-32 pb-20">
            ...
            <div className="container relative z-10 mx-auto px-4 text-center">
                ...
                >
                    ...
                    >
                        Make Confident Growth Decisions<br />
                    ...
                    >
                        Built to support ROI²™, Return on Investment and Return on Impact, ZeroFrame™ replaces fragmented tools with a unified system designed for ethical, strategic, and sustainable growth.
                    </motion.p>
                    ...
                    >
                        <div className="bg-white/80 backdrop-blur-sm p-2 flex gap-2 items-center border-b border-stone-100">
                            ...
                            <div className="ml-4 text-[10px] text-stone-400 font-mono">zeroframe.barakah.agency/intelligence-suite</div>
                        </div>
                        <Image
                            src="/assets/44.png"
